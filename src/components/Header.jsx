  ...
  return (
    ...
    <div className='flex flex-row xmedium:flex-col md:mt-[100px]'>
     ...
     <div className="flex flex-row mt-[20px]">
       ...
       <p className='text-white font-[600] text-[12px] cursor-pointer translate-y-3 font-dmsans msmaller:text-[17px] md:text-[20px]'>Learn more</p>
     </div>
     <div className="flex flex-row justify-between mt-[40px]">
       ...
       <p className='text-people-lemon text-[12px] font-[400] leading-[16px] translate-y-[10px] font-dmsans lsmall:translate-y-[20px]'>400 people online</p>
     </div>
      </div>
