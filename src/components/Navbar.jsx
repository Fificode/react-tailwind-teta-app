...
const handleClick = () => setNav(!nav);
  ...
  return (
    <div className='w-screen h-[70px] z-10 fixed top-0 bg-black-bg  py-[50px] pl-[10px]'>
        <div className="w-full h-full flex justify-between items-center">
<div className='flex flex-row'>
<img src={logo} alt="Logo" className='w-[10px] h-[14px] mx-1 md:w-[12px] md:h-[16px]'/>
...
<div className="flex pr-[20px] small:hidden">
    <button className='pr-[20px] text-[16px] font-[700] text-white bg-transparent'>Sign In</button>
    <button className='px-[30px] py-[10px] border-[1px] border-solid border-signup-lemon rounded-[10px] text-signup-lemon text-[16px] font-[700]'>Sign Up</button>
</div>
...
<div className= 'flex flex-col lsmall:hidden'>
    ...
    <button className='px-[30px] py-[10px] rounded-[10px] border-[1px] border-solid border-signup-lemon text-[16px] text-signup-lemon mr-5'>Sign Up</button>
</div>
</ul>
    </div>
  )
