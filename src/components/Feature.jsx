...
const Feature = ({image, text}) => {
  return (
    <div className='flex flex-col items-center justify-center w-[300px] h-[300px] rounded-[30px] m-2 cursor-pointer group hover:bg-signup-lemon hover:animate-scale_up_center'>
